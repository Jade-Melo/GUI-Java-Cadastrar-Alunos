...
public class JanelaPrincipal extends JFrame {
    ...
    public JanelaPrincipal() {
        ...
        //Painel Endereço
        JPanel painelEndereço = new JPanel(new GridLayout(2,2));
        painelEndereço.add(new JLabel("Rua"));
        campoRua = new JTextField(20);
        painelEndereço.add(campoRua);

        painelEndereço.add(new JLabel("Cidade"));
        campoCidade = new JTextField(20);
        painelEndereço.add(campoCidade);

        abas.add("Endereço", painelEndereço);
